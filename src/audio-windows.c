...
windows_init_sound(void)
{
    ...
    keepthreadrunning = 1;
    firstbuffer = 1;
    audio_thread = CreateThread(NULL, 0, windows_audio_thread, NULL, 0, &thread_id);
    if (! audio_thread) {
...
static struct audio_driver_channels windows_channels_cfg[]={
    { 1, 1 },
    { 2, 2 },
    { 0, 0 }
};
